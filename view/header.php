            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  <li><a href="index.php?act=account">Đăng nhập</a></li>
                  <li class="hidden-xs"><a href="index.php?act=wishlist">Yêu thích</a></li>
                  <li class="hidden-xs"><a href="index.php?act=cart">Giỏ hàng</a></li>
                  <li class="hidden-xs"><a href="index.php?act=check">Kiểm tra giỏ hàng</a></li>
                  <li><a href="" data-toggle="modal" data-target="#login-modal">Đăng kí</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.php?act=home">
                  ...
                  <p>Pet<strong>Shop</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
      ...
      <div class="menu-area">
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            <!-- Left nav -->
            <ul class="nav navbar-nav" style="margin-left:200px;margin-right:200px;">
              ...
              <li><a href="#">Sản Phẩm <span class="caret"></span></a>
                ...
                <?php
                      foreach( $dsdm as $dm ){
                        extract($dm);
                        $linkdm = "index.php?act=product&maloaicatalog=".$ma_loai;
              ...
              <!--                   
                <li><a href="#">Vòng cổ thú cưng <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                  ...
                  <li><a href="#">Balo thú cưng <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a href="#">Dành cho chó</a></li>
                      <li><a href="#">Dành cho mèo</a></li>                                    
                    </ul>
                  </li>
                  <li><a href="#">Túi xách thú cưng</a></li>
                  <li><a href="#">Nhà ở thú cưng <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a href="#">Dành cho chó</a></li>
                      <li><a href="#">Dành cho mèo</a></li>                                    
                    </ul>
                  </li>                                                
                  <li><a href="#">Đồ chơi thú cưng <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a href="#">Dành cho chó</a></li>
                      <li><a href="#">Dành cho mèo</a></li>                                    
                    </ul>
                  ...
                  <li><a href="#">Vật dụng cho thú cưng</a></li>-->
                  
               
                    
              <li><a href="#">Thú Cưng <span class="caret"></span></a>
                <ul class="dropdown-menu">  
                  <li><a href="#">Mèo kiểng</a></li>                                                                
                  <li><a href="#">Chó kiểng</a></li>              
                  <li><a href="#">Cá cảnh</a></li>
                  <li><a href="#">Cáo lửa</a></li>
                </ul>
              </li>
